...
# ///
# How to run: imported by run_sanity.py in this artifact directory.
...
def replay(model: MechanisticGraphTemporalRetina, cones: torch.Tensor) -> tuple[CheckValues, ReplayTensors]:
